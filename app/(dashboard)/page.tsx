  ...
  return (
    <>
      <PageHeader
        ...
        subtitle={`Visión consolidada del negocio · Actualizado ${new Date(data.updatedAt).toLocaleString("es-BO")}`}
        action={<ExportActions module="EJECUTIVO" filters={filters} />}
      />
      ...
      <section className="grid-2">
        <article className="card panel">
          <h2 className="panel-title">Tendencia consolidada</h2>
          <Bars data={data.trend} />
        </article>
        <article className="card panel">
          <h2 className="panel-title">Semáforo corporativo</h2>
          <div className="bars">
