  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Cumplimiento de metas por unidad y responsable"
        action={<ExportActions module="DESEMPENO" filters={filters} />}
      />
      <DataFreshness updatedAt={data.updatedAt} source={data.dataSource} />
      <FilterBar unit filters={filters} options={options} />
      <KpiGrid values={data.kpis} />
      <section className="grid-2">
        <article className="card panel">
          <h2 className="panel-title">Ranking de unidades</h2>
          <Bars data={data.ranking} drilldownParam="unit" />
        </article>
        <article className="card panel">
          <h2 className="panel-title">Matriz de cumplimiento</h2>
